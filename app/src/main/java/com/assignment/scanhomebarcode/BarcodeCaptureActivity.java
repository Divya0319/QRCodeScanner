...
public final class BarcodeCaptureActivity extends AppCompatActivity implements BarcodeGraphicTracker.BarcodeDetectorListener {
    ...
    private static final int RC_APP_SETTINGS = 9002;
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                Intent appPermissionScreenIntent = new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS);
                Uri uri = Uri.fromParts("package", getPackageName(), null);
                appPermissionScreenIntent.setData(uri);
                startActivityForResult(appPermissionScreenIntent, RC_APP_SETTINGS);
            }
        };
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == RC_APP_SETTINGS && resultCode == Activity.RESULT_OK) {
            startCameraSource();
        } else {
            Toast.makeText(this, getString(R.string.permission_camera_rationale), Toast.LENGTH_LONG).show();
        }
    }
}
